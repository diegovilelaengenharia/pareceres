...
# NOVAS VARIÁVEIS IDENTIFICADAS EM CAMPO

# Novas Variáveis Propostas pelo Gemini
...
## Extraído do arquivo `1270-2026.json` em 29/04/2026 15:15
```json
{
  "memoria_de_calculo": "Área do terreno = 330,00m² (> 220m²). Área edificada total As-Built = 139,76m². TO = 42,36%. CA = 0,43. TP = 41,88%. Área averbada original = 48,00m². Acréscimo = 91,76m². Área decadente = 119,37m² (comprovada por Planta Cadastral de Jul/2002). O engenheiro autorizou e delineou as áreas exatas para emissão de cinco documentos simultâneos, incorporando a Certidão de Localização para atestar a atualização da nomenclatura do logradouro.",
  "proprietario": "Beatriz Alves Pinto Resende e outros",
  "art_rrt": "MG20261415546",
  "zona_uso": "ZUR 2",
  "area_total_construida": "139,76m²",
  "coef_aproveitamento": "0,43",
  "licao_aprendida": "Processo de regularização atípico onde foi exigida emissão simultânea de cinco documentos regulatórios distintos para contemplar decadência parcial, averbação de acréscimo e retificação toponímica (nomenclatura de rua). A Planta Cadastral de Julho/2002 foi utilizada como prova cabal de decadência. Índices urbanísticos precisamente calibrados para a zona ZUR 2: TO 42,36%, CA 0,43 e TP 41,88%.",
  "extras_extraidos": {
    ...
    "outros": "Processo físico 715/1997 apensado na data de 13/02/2026. Atualização de nomenclatura do logradouro registrada via certidão."
  }
}
```
