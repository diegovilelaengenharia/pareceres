...
> `3_Treinar_Inteligencia/00_INSTRUCAO_SISTEMA_GEMINI.md`
...
|---------|--------------|
| `3_Treinar_Inteligencia/04_GABARITO_PARECER.md` | 3 pareceres reais como exemplo few-shot de qualidade |
| `3_Treinar_Inteligencia/05_MAPA_INTELIGENCIA.md` | Árvore de decisão + cálculos + exceções legais |
| `3_Treinar_Inteligencia/06_BLOCOS_CONSIDERANDOS.md` | Templates de considerandos com 3 camadas |
| `0_Modelos_Prontos/MODELO_GABARITO_Alvara_Regularizacao.json` | Gabarito canônico de regularização |
| `0_Modelos_Prontos/MODELO_01_Alvara_Aprovacao.json` | Gabarito de aprovação de projeto novo |
| `0_Modelos_Prontos/MODELO_14_Habitese_Multa.json` | Gabarito de habite-se com multa |
| `0_Modelos_Prontos/MODELO_15_Reforma_Ampliacao.json` | Gabarito de reforma + ampliação |
...
Padrão de qualidade: os 3 gabaritos em 04_GABARITO_PARECER.md são a referência.
...
| JSON completo | Copia e salva em `1_Colar_JSON_Aqui/` |
...
CONFIGURAÇÃO (uma vez):
  ...
  GEM > Conhecimento: suba 04, 05, 06 e os MODELO_*.json
...
DIA A DIA:
  ...
  5. Copiar o JSON → salvar em 1_Colar_JSON_Aqui/
